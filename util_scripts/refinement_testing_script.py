...
from mars.pattern_refinement import PatternRefiner, FunctionPropagator, EditScriptOptimiser
...
refiner = PatternRefiner(storage_context, edit_script_generator, FunctionPropagator(EditScriptOptimiser()))
